import torch
from utils.constants import GRAPH_TOKEN_INDEX, DEFAULT_GRAPH_TOKEN, DEFAULT_HYPERGRAPH_TOKEN
...
def tokenizer_graph_token(prompt, tokenizer, graph_token_index=GRAPH_TOKEN_INDEX, return_tensors=None):
    prompt = prompt.replace(DEFAULT_HYPERGRAPH_TOKEN, DEFAULT_GRAPH_TOKEN)
